    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('start_year', models.IntegerField(max_length=4, null=True, verbose_name='start year', blank=True)),
                ('end_year', models.IntegerField(max_length=4, null=True, verbose_name='end year', blank=True)),
